...
In a nutshell…
    ...
    Auto QA review: 21.5/135 mandatory & 0.0/46 optional
    Altogether:  15.93%
        Mandatory: 15.93%
        Optional: 0.0%
        Calculation:  15.93% + (15.93% * 0.0%)  == 15.93%
...
1. Empty session
mandatory
Score: 38.46% (Checks completed: 76.92%)
...
mandatory
Score: 21.88% (Checks completed: 43.75%)
...
5. Before request
mandatory
Score: 26.92% (Checks completed: 53.85%)
...
mandatory
Score: 5.0% (Checks completed: 10.0%)
...
mandatory
Score: 2.63% (Checks completed: 5.26%)
