...
class BasicAuth(Auth):
    ...
    def extract_base64_authorization_header(
        ...
        """
         This will return Base64 part of the Authorization
    ...
    def decode_base64_authorization_header(
        ...
        """
        This will return decoded value of Base64
    ...
    def extract_user_credentials(
        ...
        """
        This returns user email and password from the Base64 decoded value.
        """
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        """
        Here overloads Auth and retrieves the User instance for a request
        """
